...
__global__ void fused_moe_w8a8_tb_kernel(
        ...
        )
{
    ...
    for (int block=0; block < n_stages; block += 1)
    {
        ...
        switch(load_stage - compute_stage - 1)
        {
            case 0:
        ...
        )
{
    ...
    fused_moe_w8a8_tb_kernel<BM, BK, BN, PF, WM, WN, 3><<<dimGrid, dimBlock>>>(
            x,
            x_scale,
            w,
            w_scale,
