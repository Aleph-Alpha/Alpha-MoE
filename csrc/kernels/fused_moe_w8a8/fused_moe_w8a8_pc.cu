...
__global__ __launch_bounds__(256) void fused_moe_w8a8_pc_kernel(
        ...
        )
{
    ...
    gpuErrchk(cudaFuncSetAttribute(
        fused_moe_w8a8_pc_kernel<BM, BK, BN, PF, WM, WN, STAGES, TN>,
        cudaFuncAttributeMaxDynamicSharedMemorySize, sMemSize));

    fused_moe_w8a8_pc_kernel<BM, BK, BN, PF, WM, WN, STAGES, TN><<<dimGrid, dimBlock, sMemSize>>>(
            x,
            x_scale,
            w,
            w_scale,
